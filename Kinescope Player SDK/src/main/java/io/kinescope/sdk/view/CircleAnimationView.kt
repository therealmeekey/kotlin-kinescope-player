...
internal class CircleAnimationView(context: Context?, attrs: AttributeSet) :
    ...
    init {
        ...
        backgroundPaint.apply {
            ...
            isAntiAlias = true
            color = ContextCompat.getColor(context, R.color.kinescope_circle_bg_color)
        }

        circlePaint.apply {
            style = Paint.Style.FILL
            isAntiAlias = true
            color = ContextCompat.getColor(context, R.color.kinescope_circle_animation_color)
        }
    ...
    var animationDuration: Long
        get() = valueAnimator?.duration ?: 350
        set(value) {
